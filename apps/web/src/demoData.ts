...
export const demoServer: Server = {
  ...
  swapTotalGb: 8,
  primaryIp: "10.0.0.20",
  ipAddresses: ["10.0.0.20", "172.18.0.1"],
...
export const demoDomains: DomainCheck[] = [
  { id: "bit-muthu-eu", domain: "https://bit.muthu.eu", path: "/", expectedStatusCodes: [200, 301, 302, 401], editable: true, status: "healthy", statusCode: 200, responseTimeMs: 157, previousResponseTimeMs: 149, latencyTrendPercent: 5.4, uptimePercent: 99.98, checkSamples: 43200, https: true, sslExpiresAt: "2026-09-12T12:00:00.000Z", sslExpiresInDays: 66, lastCheckedAt: now(), lastSuccessfulAt: now(), lastFailedAt: null, error: null },
  { id: "cloud-muthu-eu", domain: "https://cloud.muthu.eu", path: "/", expectedStatusCodes: [200, 301, 302, 401], editable: true, status: "healthy", statusCode: 200, responseTimeMs: 231, previousResponseTimeMs: 244, latencyTrendPercent: -5.3, uptimePercent: 99.94, checkSamples: 43200, https: true, sslExpiresAt: "2026-10-02T12:00:00.000Z", sslExpiresInDays: 86, lastCheckedAt: now(), lastSuccessfulAt: now(), lastFailedAt: null, error: null },
  { id: "photos-muthu-eu", domain: "https://photos.muthu.eu", path: "/", expectedStatusCodes: [200, 301, 302, 401], editable: true, status: "critical", statusCode: 502, responseTimeMs: 91, previousResponseTimeMs: 88, latencyTrendPercent: 3.4, uptimePercent: 98.71, checkSamples: 43196, https: true, sslExpiresAt: "2026-08-28T12:00:00.000Z", sslExpiresInDays: 51, lastCheckedAt: now(), lastSuccessfulAt: null, lastFailedAt: now(), error: "Expected HTTP 200, 301, 302, 401 but received HTTP 502." },
  { id: "status-muthu-eu", domain: "https://status.muthu.eu", path: "/", expectedStatusCodes: [200, 301, 302, 401], editable: true, status: "healthy", statusCode: 200, responseTimeMs: 86, previousResponseTimeMs: 87, latencyTrendPercent: -1.1, uptimePercent: 100, checkSamples: 43200, https: true, sslExpiresAt: "2026-11-08T12:00:00.000Z", sslExpiresInDays: 123, lastCheckedAt: now(), lastSuccessfulAt: now(), lastFailedAt: null, error: null },
  { id: "nas-muthu-eu", domain: "https://nas.muthu.eu", path: "/", expectedStatusCodes: [200, 301, 302, 401], editable: true, status: "healthy", statusCode: 200, responseTimeMs: 22, previousResponseTimeMs: 24, latencyTrendPercent: -8.3, uptimePercent: 99.99, checkSamples: 43200, https: true, sslExpiresAt: "2026-12-18T12:00:00.000Z", sslExpiresInDays: 163, lastCheckedAt: now(), lastSuccessfulAt: now(), lastFailedAt: null, error: null }
];
